...
export default async function AdminLpjSpkPage({
  ...
  const inputs =
    project.spkBudgetLines.length > 0
      ? project.spkBudgetLines.map((l) => ({
          category: l.category as SpkCategoryKey,
          amount: l.amount,
          laborPercent: l.laborPercent,
          materialPercent: l.materialPercent,
          isBeliBaru: l.isBeliBaru,
        }))
