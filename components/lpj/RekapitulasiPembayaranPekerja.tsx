...
function SignCol({
  ...
  return (
    <div className="flex flex-col text-center text-xs leading-snug">
      <div className="mb-2 min-h-[2.75rem] space-y-0.5">
        <p className="min-h-[1.1rem]">{labels[0] || "\u00a0"}</p>
        <p className="min-h-[1.1rem]">{labels[1] || "\u00a0"}</p>
      </div>
